export default [
  { name: 'users', label:"name",icon: 'mdi-account-circle', routes: [ 'list' ] },
  { name: 'disciplina_docentes', icon: 'mdi-post' },
  { name: 'books' },
  { name: 'cursos', icon:"mdi-bookshelf", label: 'nome_curso' },
  { name: 'ano_letivos',  icon:"mdi-book-outline", label: 'ano_letivo' },
  { name: 'ano_academicos', icon:"mdi-bookmark-box-multiple",  label: 'ano_academico' },
  { name: 'semestres', icon:"mdi-av-timer",  label: 'semestre' },
  { name: 'turmas', icon:"mdi-google-classroom",  label: 'nome_turma' },
  { name: 'disciplinas',  icon:"mdi-book-open-page-variant-outline", label: 'nome_disciplina' },
  { name: 'docentes', icon:'mdi-account-details',label: 'nome_completo' },
